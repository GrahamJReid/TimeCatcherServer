...
from timecatcherapi.models import Event, CollaborativeTimelineEvent

@api_view(['GET'])
def events_by_collaborative_timeline(request, pk):
    ...
    try:
        timeline_events = CollaborativeTimelineEvent.objects.filter(timeline_id=pk)
